                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 wow move-up">
                        <div class="ht-box-images style-01 project-box">
                            <div class="image-box-wrap">
                                <div class="box-image">
                                    <img class="img-fluid" src="<?php echo e(asset('frontend/assets/images/projects/project1.png')); ?>" alt="Cloud Migration Project">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow move-up">
                        <div class="ht-box-images style-01 project-box">
                            <div class="image-box-wrap">
                                <div class="box-image">
                                    <img class="img-fluid" src="<?php echo e(asset('frontend/assets/images/projects/project2.jpg')); ?>" alt="Cybersecurity Upgrade Project">
                                </div>
                                <div class="content text-center">
                    ...
                    <div class="col-lg-4 col-md-6 wow move-up">
                        <div class="ht-box-images style-01 project-box">
                            <div class="image-box-wrap">
                                <div class="box-image">
                                    <img class="img-fluid" src="<?php echo e(asset('frontend/assets/images/projects/project3.jpg')); ?>" alt="Enterprise Software Development">
                                </div>
                                <div class="content text-center">
                    ...
                    <div class="col-lg-4 col-md-6 wow move-up">
                        <div class="ht-box-images style-01 project-box">
                            <div class="image-box-wrap">
                                <div class="box-image">
                                    <img class="img-fluid" src="<?php echo e(asset('frontend/assets/images/projects/project4.jpg')); ?>" alt="Mobile App Development">
                                </div>
                                <div class="content text-center">
                    ...
                    <div class="col-lg-4 col-md-6 wow move-up">
                        <div class="ht-box-images style-01 project-box">
                            <div class="image-box-wrap">
                                <div class="box-image">
                                    <img class="img-fluid" src="<?php echo e(asset('frontend/assets/images/projects/project5.jpg')); ?>" alt="Data Analytics Dashboard">
                                </div>
                                <div class="content text-center">
                    ...
                    <div class="col-lg-4 col-md-6 wow move-up">
                        <div class="ht-box-images style-01 project-box">
                            <div class="image-box-wrap">
                                <div class="box-image">
                                    <img class="img-fluid" src="<?php echo e(asset('frontend/assets/images/projects/project6.jpg')); ?>" alt="IT Infrastructure Setup">
                                </div>
                                <div class="content text-center">
...
<?php echo $__env->make('frontend.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/susant/Desktop/Work/All nepal tech solution/resources/views/frontend/pages/project.blade.php ENDPATH**/ ?>