                        ...
                        <div class="header__navigation d-none d-xl-block">
                            <nav class="navigation-menu primary--menu">
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(url('/about')); ?>"><span>About</span></a></li>
                                    <li><a href="<?php echo e(url('/project')); ?>"><span>Projects</span></a></li>
                                    <li><a href="<?php echo e(url('/service')); ?>"><span>Services</span></a></li>
                                    <li><a href="<?php echo e(url('/contact')); ?>"><span>Contact</span></a></li>
                                </ul>
                            </nav>
                        </div>
...
<div class="mobile-menu d-xl-none">
    <nav>
        ...
        <a href="<?php echo e(url('/contact')); ?>" class="btn btn-primary mt-3">Get a Quote</a>
    </nav>
</div>
...
<?php /**PATH /Users/susant/Desktop/Work/All nepal tech solution/resources/views/frontend/layout/navbar.blade.php ENDPATH**/ ?>