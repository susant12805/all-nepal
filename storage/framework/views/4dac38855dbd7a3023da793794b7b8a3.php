...
<div class="page-header mt-0 shadow p-3">
    ...
    <div class="btn-group mb-0">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item" href="<?php echo e(route('services.create')); ?>"><i class="fas fa-plus mr-2"></i>Add new Service</a>
        </div>
    </div>
</div>
<div class="container">
                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <div class="">
                                        <div class="">    
                                            <a href="<?php echo e(route('services.show', $service->id)); ?>" class="btn btn-sm btn-primary">View</a>
                                        </div>
                                        <div class=""> 
...
<?php echo $__env->make('user.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/livescor/techversesolutionspvtltd.com/resources/views/user/pages/services/index.blade.php ENDPATH**/ ?>