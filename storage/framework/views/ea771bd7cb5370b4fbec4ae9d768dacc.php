                        ...
                        <div class="row">
                            <div class="col-lg-8 m-auto">
                                <div class="about-banner-content text-center">
                                    <h1 class="mb-15 text-white">About All Nepal Tech Solutions</h1>
                                    <h5 class="font-weight--normal text-white">All Nepal Tech Solutions specializes in technological and IT-related services such as product engineering, warranty management, building cloud, infrastructure, network, etc. </h5>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 offset-lg-1">
                                    <div class="cybersecurity-about-text">
                                        <div class="text">We specialized in technological and IT-related services such as product engineering, warranty management, building cloud, infrastructure, network, etc. We put a strong focus on the needs of your business to figure out solutions that best fits your demand and nail it.</div>
                                                ...
                                                <div class="image-box-wrap">
                                                    <div class="box-image">
                                                        <div class="default-image">
                                                            <img class="img-fluid" src="<?php echo e(asset('frontend/assets/images/icons/mitech-box-image-style-06-image-01-120x120.webp')); ?>" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-4 col-md-6 wow move-up">
                                            ...
                                            <div class="ht-box-images style-06">
                                                <div class="image-box-wrap">
                                                    <div class="box-image">
                                                        <div class="default-image">
                                                            <img class="img-fluid" src="<?php echo e(asset('frontend/assets/images/icons/mitech-box-image-style-06-image-02-120x120.webp')); ?>" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-4 col-md-6 wow move-up">
                                            ...
                                            <div class="ht-box-images style-06">
                                                <div class="image-box-wrap">
                                                    <div class="box-image">
                                                        <div class="default-image">
                                                            <img class="img-fluid" src="<?php echo e(asset('frontend/assets/images/icons/mitech-box-image-style-06-image-03-120x120.webp')); ?>" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                ...
                                <div class="delivering-optimal-wrap">
                                    ...
                                    <div class="list-item">
                                        ...
                                        <div class="title-wrap">
                                            ...
                                            <div class="desc">At All Nepal Tech Solutions, we have a holistic and integrated approach towards core modernization to experience technological evolution. </div>
                                        </div>
                                    </div>
                                    <div class="list-item">
                                        <div class="marker"></div>
...
<?php echo $__env->make('frontend.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/susant/Desktop/Work/All nepal tech solution/resources/views/frontend/pages/about.blade.php ENDPATH**/ ?>