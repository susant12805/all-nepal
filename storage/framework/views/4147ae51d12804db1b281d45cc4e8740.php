        ...
        <div class="col-lg">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('heroimage.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Enter Hero Image Name" value="<?php echo e(old('name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="link" name="link" rows="4" placeholder="Paste link here.." required></textarea>
                                </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/livescor/techversesolutionspvtltd.com/resources/views/user/pages/heroimage/create.blade.php ENDPATH**/ ?>