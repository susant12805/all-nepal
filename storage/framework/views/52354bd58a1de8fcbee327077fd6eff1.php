        ...
        <div class="col-lg">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('team.update', $team->id)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Enter Name" value="<?php echo e($team->name); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="designation" placeholder="Enter Designation" value="<?php echo e($team->designation); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="phone" placeholder="Enter Phone" value="<?php echo e($team->phone); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="testimonial" name="testimonial" rows="4" placeholder="Testimonial here.."><?php echo e($team->testimonial); ?></textarea>
                                </div>
...
<?php echo $__env->make('user.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/livescor/techversesolutionspvtltd.com/resources/views/user/pages/team/edit.blade.php ENDPATH**/ ?>