                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 wow move-up">
                                    ...
                                    <div class="ht-box-images style-01">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{ asset('frontend/assets/images/icons/Mitech-box-image-style-01-image-01-100x108.webp') }}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-4 col-md-6 wow move-up">
                                    ...
                                    <div class="ht-box-images style-01">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{ asset('frontend/assets/images/icons/Mitech-box-image-style-01-image-02-100x108.webp') }}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-4 col-md-6 wow move-up">
                                    ...
                                    <div class="ht-box-images style-01">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{ asset('frontend/assets/images/icons/Mitech-box-image-style-01-image-03-100x108.webp') }}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-4 col-md-6 wow move-up">
                                    ...
                                    <div class="ht-box-images style-01">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{ asset('frontend/assets/images/icons/Mitech-box-image-style-01-image-04-100x108.webp') }}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-4 col-md-6 wow move-up">
                                    ...
                                    <div class="ht-box-images style-01">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{ asset('frontend/assets/images/icons/Mitech-box-image-style-01-image-05-100x108.webp') }}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-4 col-md-6 wow move-up">
                                    ...
                                    <div class="ht-box-images style-01">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{ asset('frontend/assets/images/icons/Mitech-box-image-style-01-image-06-100x108.webp') }}" alt="">
                                            </div>
                                            <div class="content">
