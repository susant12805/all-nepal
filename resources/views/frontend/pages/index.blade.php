                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="infotechno-hero-text  wow move-up">
                                ...
                                <div class="hero-button mt-30">
                                    <a href="{{ url('/service') }}" class="ht-btn ht-btn-md">Get details</a>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="infotechno-hero-inner-images">
                                <div class="infotechno-inner-one">
                                    <img class="img-fluid"
                                         src="{{ asset('frontend/assets/images/hero/home-infotechno-main-slider-slide-01-image-01.webp') }}"
                                         alt="">
                                </div>
                                <div class="infotechno-inner-two wow move-up">
                                    <img class="img-fluid"
                                         src="{{ asset('frontend/assets/images/hero/unnamed3.jpg') }}"
                                         alt="">
                                </div>
                            </div>
                        </div>
