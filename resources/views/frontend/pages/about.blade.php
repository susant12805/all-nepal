                                                ...
                                                <div class="image-box-wrap">
                                                    <div class="box-image">
                                                        <div class="default-image">
                                                            <img class="img-fluid" src="{{ asset('frontend/assets/images/icons/mitech-box-image-style-06-image-01-120x120.webp') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-4 col-md-6 wow move-up">
                                            ...
                                            <div class="ht-box-images style-06">
                                                <div class="image-box-wrap">
                                                    <div class="box-image">
                                                        <div class="default-image">
                                                            <img class="img-fluid" src="{{ asset('frontend/assets/images/icons/mitech-box-image-style-06-image-02-120x120.webp') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-4 col-md-6 wow move-up">
                                            ...
                                            <div class="ht-box-images style-06">
                                                <div class="image-box-wrap">
                                                    <div class="box-image">
                                                        <div class="default-image">
                                                            <img class="img-fluid" src="{{ asset('frontend/assets/images/icons/mitech-box-image-style-06-image-03-120x120.webp') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="content">
