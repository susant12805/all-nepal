                ...
                <div class="container">
                    <div class="row footer-widget-wrapper">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                <li><a href="{{ url('/') }}" class="hover-style-link">Home</a></li>
                                <li><a href="{{ url('/about') }}" class="hover-style-link">About</a></li>
                                <li><a href="{{ url('/project') }}" class="hover-style-link">Projects</a></li>
                                <li><a href="{{ url('/service') }}" class="hover-style-link">Services</a></li>
                                <li><a href="{{ url('/contact') }}" class="hover-style-link">Contact</a></li>
                            </ul>
                        </div>
