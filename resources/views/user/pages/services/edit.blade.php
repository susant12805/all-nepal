                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="short_description" name="short_description" rows="3" maxlength="500" required>{{ $service->short_description }}</textarea>
                                    <small class="text-muted">Max 500 characters</small>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="icon" class="form-label">Icon Class (Font Awesome)</label>
                                    <input type="text" class="form-control" id="icon" name="icon" value="{{ $service->icon }}" placeholder="fas fa-icon">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($service->image)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->name }}" width="100" class="img-thumbnail">
